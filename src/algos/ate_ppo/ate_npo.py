...
class ATENPO(RLAlgorithm):
    ...
    def __init__(self,
        ...
        encoder_optimizer = encoder_optimizer or LBFGSOptimizer
        encoder_optimizer_args = encoder_optimizer_args or dict()
    ...
    def _build_policy_loss(self, i):
        ...
        with tf.name_scope('policy_loss'):
            ...
            with tf.name_scope('loss'):
                ...
                pol_loss = -tf.reduce_mean(obj)

                # Encoder entropy bonus
                encoder_loss = -pol_loss - self.encoder_ent_coeff * encoder_entropy
        ...
        return encoder_loss, pol_loss, pol_mean_kl, encoder_mean_kl
    ...
    def _train_encoder_network(self, policy_opt_input_values):
        ...
        Returns:
            float: Encoder loss after optimization.

        """
        logger.log('Computing loss before')

        loss_before = self._encoder_optimizer.loss(policy_opt_input_values)
    ...
    def _train_policy_network(self, policy_opt_input_values):
        ...
        loss_before = self._policy_optimizer.loss(policy_opt_input_values)
