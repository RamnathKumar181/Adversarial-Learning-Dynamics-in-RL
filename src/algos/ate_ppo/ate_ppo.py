...
class ATEPPO(ATENPO):
    ...
    def __init__(self,
        ...
        policy_optimizer_args = policy_optimizer_args or dict(batch_size=32,
                                                              max_episode_length=10)

        encoder_optimizer = encoder_optimizer or FirstOrderOptimizer
        encoder_optimizer_args = encoder_optimizer_args or dict(batch_size=32,
                                                                max_episode_length=10)
        ...
        super().__init__(env_spec=env_spec,
                         ...
                         policy_optimizer_args=policy_optimizer_args,
                         encoder_optimizer=encoder_optimizer,
                         encoder_optimizer_args=encoder_optimizer_args,
